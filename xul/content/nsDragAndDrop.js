 ...
 *
 * Use: map the handler functions to the 'ondragstart', 'ondragover' and
 *   'ondrop' event handlers on your XML element, e.g.
 *   <xmlelement ondragstart="nsDragAndDrop.startDrag(event, observer);"
 *               ondragover="nsDragAndDrop.dragOver(event, observer);"
 *               ondrop="nsDragAndDrop.drop(event, observer);"/>
 *
